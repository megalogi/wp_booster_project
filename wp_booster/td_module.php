...
abstract class td_module {
    ...
    function __construct($post) {
	    ...
	    $this->td_review = get_post_meta($this->post->ID, 'td_post_theme_settings');
    ...
    function get_category() {
	    ...
	    if (array_key_exists($current_post_type, $builtin_post_types)) {
		    ...
		    $td_post_theme_settings = get_post_meta($this->post->ID, 'td_post_theme_settings');
    ...
    function get_quotes_on_blocks() {
        ...
        $post_data_from_db = get_post_meta($this->post->ID, 'td_post_theme_settings');
